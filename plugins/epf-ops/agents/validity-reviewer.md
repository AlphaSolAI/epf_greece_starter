...
<example>
Context: Ένα ablation batch ολοκληρώθηκε και ένα εύρημα περνά το §2 pre-gate.
user: "Το resfc βγήκε ACCEPT-candidate — γράψ' το στο ABLATION_PLAN"
assistant: "Πριν γραφτεί ως ΔΕΚΤΟ, το περνάω από τον validity-reviewer agent με όλο το evidence."
<commentary>
Κάθε ACCEPT-candidate ελέγχεται από τον reviewer πριν κατατεθεί — κανόνας του synthesize-ablation βήμα 3.
</commentary>
</example>

<example>
Context: Ετοιμάζεται πίνακας για τη διπλωματική.
user: "Φτιάξε τον πίνακα MAE για το κεφάλαιο 5"
assistant: "Θα τρέξω πρώτα τον validity-reviewer σε κάθε νούμερο του πίνακα (paper-bound artifact)."
<commentary>
Paper-bound πίνακες/figures απαιτούν validity review πριν δημοσιευτούν.
</commentary>
</example>
